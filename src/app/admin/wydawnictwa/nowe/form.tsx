...
export function NewPublisherForm({ publishers }: Props) {
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea id="description" name="description" rows={3} className={textareaClass} />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="collaborationUrl" name="collaborationUrl" type="url" placeholder="https://..." />
